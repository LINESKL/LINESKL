...
В мае 2026 завершил ключевой этап системы для **MVP Volleyball Academy** и присоединился к **ТОО «GMS Construction»**, где вместе с коллегой веду enterprise ERP для крупной строительной компании: отвечаю за frontend-архитектуру и разделяю DevOps/инфраструктуру.
